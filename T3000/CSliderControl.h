...
public:
	...
	unsigned long get_LinesColor()
	{
		...
		InvokeHelper(0x60020014, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, NULL);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x6002001e, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x6002002a, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	...
	{
		BOOL result;
		InvokeHelper(0x60020030, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	...
	CString ValueToText(float value)
	{
		CString result;
		static BYTE parms[] = VTS_R4;
		InvokeHelper(0x60020037, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, value);
		return result;
	}
	...
	{
		unsigned long result;
		InvokeHelper(0x6002003d, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, NULL);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x60020043, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
